...
namespace RiotSharp
{
    ...
    public class TournamentRiotApi : ITournamentRiotApi
    {
        ...
        private const string MatchRootUrl = "/lol/match/v4/matches/{0}";
        private const string GetMatchIdUrl = "/by-tournament/{0}/ids";
        private const string GetMatchDetailUrl = "/by-tournament-code/{0}";
            ...
            var json =
                await
                    _requester.CreateGetRequestAsync(
                        string.Format(MatchRootUrl, matchId) + string.Format(GetMatchDetailUrl, tournamentCode), region,
                        new List<string>
                        {
        ...
        private void SetTournamentRootUrl(bool useStub = false)
        {
